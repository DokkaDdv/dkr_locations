...
<body>
    ...
    <div class="container">
        <div class="nav-menu">
            ...
            <a href="index.php?page=admin_clients" class="btn btn-primary">Clients</a>
        </div>
        ...
        <div class="card">
            ...
            <form method="POST" action="index.php?page=admin_clients">
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="index.php?page=admin_clients" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
        <?php else: ?>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=admin_clients&edit_client=<?php echo (int)$c['id']; ?>" class="btn btn-small btn-warning">Modifier</a>
                            <?php if ($c['nb_locations'] == 0): ?>
                                <a href="index.php?page=admin_clients&delete_client=<?php echo (int)$c['id']; ?>"
