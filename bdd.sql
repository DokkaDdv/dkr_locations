...
-- Vehicules de demo
INSERT INTO vehicles (marque, modele, immatriculation, tarif, statut) VALUES
('Renault', 'Clio', 'AB-123-CD', 35.00, 'disponible'),
('Peugeot', '208', 'EF-456-GH', 40.00, 'disponible'),
('Citroen', 'C3', 'IJ-789-KL', 32.00, 'disponible'),
('BMW', 'Serie 3', 'MN-012-OP', 80.00, 'disponible'),
('Mercedes', 'Classe A', 'QR-345-ST', 75.00, 'disponible'),
('Toyota', 'Yaris', 'UV-678-WX', 38.00, 'disponible'),
('Volkswagen', 'Golf', 'YZ-890-AB', 45.00, 'disponible'),
('Audi', 'A3', 'CD-123-EF', 70.00, 'disponible'),
('Nissan', 'Micra', 'GH-456-IJ', 30.00, 'disponible'),
('Ford', 'Focus', 'YZ-901-AB', 42.00, 'disponible')
